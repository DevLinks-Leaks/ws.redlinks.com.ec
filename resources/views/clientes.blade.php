		...
		<div class="row">
			<div class="col-md-4 col-md-offset-2">
				<div class="form-group">
					<label>Ruc</label>
					<input id="txt_ruc" name="txt_ruc" type="text" class="form-control" maxlength="15"/>
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group">
					...
					<tr>
						...
						<td class="text-right">
							<div class="btn-group btn-group-sm" role="group">							
								@if ($local->estado=="A")
								<a class="btn btn-default" href="/locales/{{ $local->id }}/descargar" target="_blank" title="Descargar fotos"><span class="glyphicon glyphicon-download"></span></a>
